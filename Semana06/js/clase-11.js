    ...
    return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {
            ...
            if (url == "www.google.com") {
                ...
                resolve(renderizarElementos(listadoComentarios))
...
function renderizarElementos(listado){
    const claseComentarios = document.querySelector(".comentarios")
    claseComentarios.innerHTML = ''
    // claseComentarios.innerHTML
    ...
    listado.forEach(comentario => {
        ...
        `;
        claseComentarios.innerHTML += comentarioHTML;
    });
