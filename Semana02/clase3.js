...
function elegirTema() {
    ...
    const sitio = document.querySelector("body")
    const botonTema = document.querySelector(".tema button");

    const modoOscuro = confirm("Si desea usar el modo oscuro de click en ACEPTAR, de lo contrario de click en CANCELAR");
    // const modoClaro = confirm("¿Desea usar el modo claro?");
